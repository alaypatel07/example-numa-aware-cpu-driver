...
func newApp() *cli.App {
	...
	app := &cli.App{
		Name:            "example-numa-aware-cpu-kubeletplugin",
		Usage:           "example-numa-aware-cpu-kubeletplugin implements a DRA driver plugin for numa aware CPU management.",
		ArgsUsage:       " ",
